...
public class EvaluationRuleRestClient {
	...
	public EvaluationRule invokeGetEvaluationRuleById(long evaluationRuleId) {
		...
		Resource resource = client
				.resource("http://localhost:9080/edu-test-8/rest/evaluationRules/" + evaluationRuleId);
	...
	public void invokeGetAllEvaluationRule() {
		...
		RestClient client = new RestClient();
		// Create the resource instance to interact with
		Resource resource = client.resource("http://localhost:9080/edu-test-8/rest/evaluationRules");
	...
	public EvaluationRule invokePostEvaluationRule(EvaluationRule evaluationRule) {
		...
		// Create the resource instance to interact with
		Resource resource = client.resource("http://localhost:9080/edu-test-8/rest/evaluationRules/evaluationRule");
